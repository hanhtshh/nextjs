...
import AppStoreIcon from "../../public/images/appStoreIcon.svg";
import PlayStoreIcon from "../../public/images/playStoreIcon.svg";
export const TELIO_BLOG = "https://blog.telio.vn/";
...
export const TELIO_CAREERS = "http://hiring.telio.vn/";
...
export const DELIVERY_POLICY = `/Delivery-Policy.pdf`;
export const PAYMENT_POLICY = `/Payment-Policy.pdf`;
export const RETAILERS_POLICY = `/Retailers-Policy.pdf`;
export const RETURNING_POLICY = `/Returning-Policy.pdf`;
export const SECURITY_POLICY = `/Security-Policy.pdf`;
